...
export default function Home(){
    return(
        <div className="bg-gradient-to-b from-slate-900 to-slate-700/30 text-white">
            ...
            <section className="py-20 bg-gradient-to-br from-slate-800/30 to-blue-500/20 mb-20">
            ...
            <section className="py-20 bg-gradient-to-br from-blue-500/20 to-slate-800/10 mb-20">
